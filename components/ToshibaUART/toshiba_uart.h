...
// Cooling/Heating mode commands - captured from actual Toshiba wall controller
// Uses 0x01:0x22 register with 0x05:0x05 for cooling, 0x04:0x04 for heating
const uint8_t  INST_COOLING_MODE_ON[12]  = {0xF0, 0xF0, 0x0C, 0x60, 0x70, 0xE0, 0x01, 0x22, 0x05, 0x05, 0xE9, 0xA0};
const uint8_t  INST_HEATING_MODE_ON[12]  = {0xF0, 0xF0, 0x0C, 0x60, 0x70, 0xE0, 0x01, 0x22, 0x04, 0x04, 0xE7, 0xA0};
