...
// Cooling/Heating mode commands - use 0x01 (write) instead of 0x41 (query)
const uint8_t  INST_COOLING_MODE_ON[15]  = {0xF0, 0xF0, 0x0F, 0x60, 0x70, 0xE0, 0x01, 0x0C, 0x81, 0x00, 0x00, 0x48, 0x00, 0x95, 0xA0};
const uint8_t  INST_HEATING_MODE_ON[15]  = {0xF0, 0xF0, 0x0F, 0x60, 0x70, 0xE0, 0x01, 0x0C, 0x01, 0x00, 0x00, 0x48, 0x00, 0x15, 0xA0};
