...
// Cooling mode commands - captured from actual Toshiba wall controller
// Uses 0x01:0x22 register with 0x05:0x05 for cooling, 0x00:0x00 to disable cooling (heating mode)
const uint8_t  INST_COOLING_MODE_ON[12]   = {0xF0, 0xF0, 0x0C, 0x60, 0x70, 0xE0, 0x01, 0x22, 0x05, 0x05, 0xE9, 0xA0};
const uint8_t  INST_COOLING_MODE_OFF[12]  = {0xF0, 0xF0, 0x0C, 0x60, 0x70, 0xE0, 0x01, 0x22, 0x00, 0x00, 0xDF, 0xA0};
