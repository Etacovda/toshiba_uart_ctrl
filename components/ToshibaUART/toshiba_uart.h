...
// Uses 0x01:0x22 register with 0x05:0x05 for cooling, 0x05:0x00 for heating
const uint8_t  INST_COOLING_MODE_ON[12]  = {0xF0, 0xF0, 0x0C, 0x60, 0x70, 0xE0, 0x01, 0x22, 0x05, 0x05, 0xE9, 0xA0};
const uint8_t  INST_HEATING_MODE_ON[12]  = {0xF0, 0xF0, 0x0C, 0x60, 0x70, 0xE0, 0x01, 0x22, 0x05, 0x00, 0xE4, 0xA0};
