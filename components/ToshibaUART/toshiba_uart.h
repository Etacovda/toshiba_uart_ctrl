...
// Cooling mode command - captured from actual Toshiba wall controller
// Uses 0x01:0x22 register with 0x05:0x05 for cooling
// Heating mode: no direct command known - use zone toggle (OFF then ON) to reset to heating
